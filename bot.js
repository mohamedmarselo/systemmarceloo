...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'مارسيلو') {  //WESO#0001
      msg.reply('**نعم**');  //WESO#0001
    }
  });
...
message.channel.sendEmbed(embed)
 ...
 const kingmas = [
    '*** منشن لكلو وقولهم انا بكرهكم. ***',
 '*** اتصل ب امك و قولها انك بتحبها :heart:. ***',
    '***     اتصل ب امك  وقولها انك بتحب واحده.***',
    '*** اتصل ب ظابط وقوله عندكم مطافي.***',
    '*** صور اي حاجه  حاجه و يطلبوها منك .***',
    '*** اكتب في الشات اي حاجه يطلبها منك الاعبين في الخاص. ***',
    '*** اتصل ب حد من اخواتك , و اطلب منهم مبلغ على اساس انك كسرت الموبايل.***',
    '*** اضرب اي حد جنبك ولو مفيش حد جنبك اضرب نفسك.***',
    '***  تروح عند حد وتقولو بحبك. ***',
    '***روح عند اي احد في الخاص و قول له انك بتحبه واتكلم معاه.***',
    '*** روح ل اي حد متعرفوش وقولو انت كيوت وعاوز ابوسك. ***',
    '*** روح الى اي جروب على الواتس و اكتب حاجه يطلبها منك اللاعبين الحد الاقصى 3 رسائل. ***',
    '*** لو انت ولد روح لبنت وقولها بحبك ولو انتي بنت روحي لصحبتك وقولها بحبك. ***',
    '*** لو انت ولد روح نام لو انتي بنت روحي نامي .***',
    '*** ارمي جوالك على الارض بقوة و اذا انكسر صور الجوال و ارسله في الشات العام.***',
    '*** اتصل على ابوك و قول له انك رحت مع بنت و احين هي حامل..... ***',
    '*** تكلم باللهجة السودانية الين يجي دورك مرة ثانية.***',
    '***اعمل مشهد تمثيلي عن مصرية بتولد.***',
    '*** قول نكتة ولازم واحد يضحك لو محدش ضحك يعملولك ميوت. ***',
    '*** انتحر وارمي نفسك من فوق السرير.***',
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = ['MarseLo',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`Online`);
    }, ms);
...
client.on('message', message => {
  ...
  if(!message.channel.guild) return message.reply('** This command only for servers **')
   ...
   if(sabotage == message.author)return message.reply(`**هتنتحر وتسيبني ؟**`);
    if(sabotage === client.user) return message.reply(`** عاوز تقتلني ؟ **`);
  if (sabotage < 1) {
    message.delete();
...
var Za7f = [
  "**صورة وجهك او رجلك او او بوقك او يدك**.",
  "**اصدر اي صوت يطلبه منك الاعبين**.",
  "**متتكلمش و قول كلمة من اختيار الاعبين الي معك**.",
  "**روح الى اي جروب عندك في الواتس اب و اكتب اي شيء يطلبه منك الاعبين  الحد الاقصى 3 رسائل**.",
  "**قول نكتة ولو محدش ضحك تاخد ميوت**.",
  "**قول ل اي بنت بتكراش عليها  بحبك**.",
  "**مفيش المرة دي **.",
  "**ارمي الفون بتاعك على الارض لو اتكسر صورو وابعت في الشات **.",
  "**صور اي حاجه تتطلب منك**.",
  "**اتصل ب ابوك وقولو انك نمت مع بنت وهي دلوقتي حامل....**.",
  "**متكلمش اللعبه**.",
  "**اعمل مشهد تمثيلي عن مصرية بتولد**.",
  "**اضرب اي حد جنبك لو مفيش حد جنبك اضرب نفسك**.",
  "**هعديهالك المرة دي **.",
  "**تعطي اي شخص 5 الاف كرديت**.",
  "",
  "**روح عند اي احد خاص وقولو انك بتحبو**.",
  "**اكتب في الشات اي حاجه يطلبها منك الاشخاص في الخاص**.",
  "**قول نكتة اذا و لازم احد الاعبين يضحك اذا محد ضحك يعطونك ميوت الى ان يجي دورك مرة ثانية**.",
  "**سامحتك خلاص مافيه عقاب لك :slight_smile:**.",
  "**اتصل على احد من اخوياك  خوياتك , و اطلب منهم مبلغ على اساس انك صدمت بسيارتك**.",
  "**غير اسمك ل اي اسم بنت تختارهولك**.",
  "**اتصل ب امك و قولها انك تحبها :heart:**.",
  "**لا يوجد سؤال لك سامحتك :slight_smile:**.",
  "**قل لواحد متعرفوش اضربني**.",
  "**منشن ل كلو وقولهم بكرهكم**.",
  "**اتصل ب اخوك وقولو انك عملت حادثه**.",
  "**روح المطبخ و اكسر مج او كوبايه**.",
  "**قول لاي بنت موجود في الروم كلمة حلوه**.",
  "**تكلم باللغة الانجليزية لمدة ربع ساعه مع اي حد في السيرفراذا لو متكلمتش تنفذ عقاب ثاني**.",
  "**لا تتكلم ولا كلمة لمدة 10 دقايق و لو اتكلمت  تاخد ميوت لمدة يوم كامل من السيرفر**.",
  "**قول اغنيه **.",
  "**تكلم باللهجة السودانية مع اي حد في السيرفر لمدة ربع ساعه لو متكلمتش تنفذ عقاب تاني**.",
  "**اتصل على احد من اخوياك  خوياتك , و اطلب منهم مبلغ على اساس انك صدمت بسيارتك**.",
  "**اول واحد تشوفه اضربو **.",
  ...
  "**ارمي اي حاجه قدامك على اي احد موجود او على نفسك**.",
  "**روح ل اي واحد متعرفوش وقوله انا كيوت وعاوز بوسه**.",
  "**تتصل ب امك و تقول لها خطفت بنت**.",
  "** تتصل ب امك وقولها انا اتجوزت عرفي **.",
  "**تتصل ب امك وقولها انا بحب جارتنا**.",
    "**تتصل ب البوليس تقولهم عندكم مطافي**.",
    "**خلاص سامحتك**.",
    "** تقول في الشارع انا  مجنوون**.",
    "** تروح عند حد وتقولو بحبك اوي**.",
...
if(message.content.startsWith(prefix + 'move')) {
 ...
 return message.channel.send("``Use : " +prefix+ "اسحب @user")
}
...
client.on('message',  (message) => {
  ...
  message.channel.send({
    embed: {
      description: `${message.author.username}اداك بوسه ${user.username}!`,
      image: {
...
client.on('message', message => {    
  ...
  client.on("message", function(message) {
    var prefix = "#";
   if(message.content.startsWith(prefix + "mars")) {
    let messageArgs = message.content.split(" ").slice(1).join(" ");
    let messageRPS = message.content.split(" ").slice(2).join(" ");
    let arrayRPS = ['**# - Rock**','**# - Paper**','**# - Scissors**'];
    let result = `${arrayRPS[Math.floor(Math.random() * arrayRPS.length)]}`;
...
"س ي ر ف ر",
" م ا ر س ي ل و",
"ا ر ن ب ن ا ف ي م ن و ر ا ن و ر",
"ب ح ب ك",
"ريشا",
"ب ا ش ا م ص ر",
"ا ل ت ن و ع",
"ع م ل ة ر ئ ي س ي ة",
"ص د ق ا ل م ر ء ن ج ا ت ه",
"إ م ب و ر ي و أ ر م ا ن ي",
"ا ل ق ب ر",
"ل ا ك و س ت",
"ا ل و ا ر د",
"ت خ ص ي ص",
...
لديك 15 ثانية`).then(msg1=> {
        ...
        r.then((collected)=> {
            message.channel.send(`${collected.first().author}فكيت الكلمه ^_^`);
        })
        })
    }
})
...
لديك 15 ثانية لكتابة عاصمة صحيحة`).then(msg1=> {
            var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
                maxMatches : 1,
                time : 15000,
                errors : ['time']
...
client.on('message', message => {
   if(message.channel.type === "dm") return;
     if(message.content.startsWith ("تتجوزيني")) {
     if(!message.channel.guild) return message.reply(' This command only for servers ')
     var proposed = message.mentions.members.first()
 
     if(!message.mentions.members.first()) return message.reply('اطلب ايد واحده').catch(console.error);
     if(message.mentions.users.size > 1) return message.reply('مينفعش ولد ي شاذ').catch(console.error);
...
.then(collected =>{
   message.channel.send(`**${message.author} و ${proposed} الف مبروك ليكو **`);
})
...
.then(collected =>{
  message.channel.send(`**${message.author} مش عاوزه تتجوز`);
})
